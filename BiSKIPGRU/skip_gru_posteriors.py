...
import bi_skip_gru_model_evaluation
	...
	with tf.Graph().as_default():
		...
		with tf.device('/cpu:0'):
			with tf.variable_scope('model'):
				val_model = bi_skip_gru_model_evaluation.Model(audio_features_val,audio_labels_val,seq_length_val,config,is_training=None)

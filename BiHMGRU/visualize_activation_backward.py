...
states=np.load('z_states/exp{}/states_backward_epoch{}_sentence{}.npy'.format(exp_num,epoch,sentence))
activations=np.load('z_states/exp{}/activations_backward_norm_epoch{}_sentence{}.npy'.format(exp_num,epoch,sentence))
logits=np.load('z_states/exp{}/logit_states_backward_epoch{}_sentence{}.npy'.format(exp_num,epoch,sentence))
...
plt.tight_layout()
plotname='z_states/activation_backward_exp{}_epoch{}_sentence{}'.format(exp_num,epoch,sentence)
